...
const TermsAndConditionsItem = (props) => {
  return (
    <div>
      <h1 className="text-2xl mt-6 pb-2 lg:px-0 font-bold text-black">
        {props.content.header}
      </h1>
      <p className="whitespace-pre-line">{props.content.description}</p>
    </div>
  );
};
...
const TermsAndConditions = () => {
  const content = [
    {
      header: "OVERVIEW",
      description: `This website is operated by Recoverly. Throughout the site, the terms “we”, “us” and “our” refer to Recoverly. Recoverly offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
    ...
    {
        header: "SECTION 5 - PRODUCTS OR SERVICES",
    ...
    },
    {
        ...
        description: `Your submission of personal information through the store is governed by our Privacy Policy. To understand more, view our Privacy Policy.`
    },
    {
    ...
    },
    {
        ...
        description: `You agree to indemnify, defend and hold harmless Recoverly and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.`
    },
    {
    ...
    },
    {
        ...
        description: `These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Singapore`
    },
    {
    ...
    },
    {
        ...
        description: `Questions about the Terms of Service should be sent to us at ${<a href="mailto:hello@recoverly.sg">hello@recoverly.sg</a>}`
    }
  ];

  // function to render all the content
  const contentItems = content.map((content, index) => {
    return <TermsAndConditionsItem key={index} content={content} />;
  });
