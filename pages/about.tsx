    ...
    <ShopNav>
        ...
        <div className="flip border-4 border-black mt-20 text-center p-6">
          <div className="flip-content flexjustify-center">
            ...
            <div className="flip-back">
              <p>
                SMEs face an issue with monetary and resource capital locked up
                in inventory due to:{" "}
              </p>
              <br />
      ...
      <div className="border-4 border-black mt-20 text-center p-4">
        ...
        <p className="mt-6 mb-4">
          More importantly, our goal is to re-circulate as many of these unused
          products, minimizing our region’s environmental waste while maximizing
          our SMEs’ monetary capital
        </p>
      </div>
